...
class BaseOptions():
    ...
    def gather_options(self):
        ...
        model_option_setter = application.image_generator.spade.models.get_option_setter(model_name)
        parser = model_option_setter(parser, self.isTrain)

        # modify dataset-related parser options
        dataset_mode = opt.dataset_mode
        dataset_option_setter = application.image_generator.spade.data.get_option_setter(dataset_mode)
